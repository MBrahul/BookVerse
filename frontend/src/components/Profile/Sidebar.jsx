    ...
    return (
        <div className='bg-zinc-800 p-4 rounded flex flex-col items-center justify-between h-auto lg:h-[100%]'>
            ...
            <div className='flex flex-col items-center justify-center'>
                <img src={profile.avatar} alt="" className='h-[12vh]' />
                <p className="mt-3 text-xl text-zinc-100 font-semibold">{profile.username}</p>
                <p className="mt-1 text-normal text-zinc-300">{profile.email}</p>
